        ...
        match request.request.target() {
            ActiveMessageTarget::HumanAttempt { .. } => (
                if matches!(
                    ...
                    ResolvedSend::Fail(ActiveAgentMessageOutcome::NotFoundOrNotOwned)
                },
    ...
    pub(super) fn resolve_send(
        ...
        match target {
            ActiveMessageTarget::HumanAttempt {
                ...
                if child.attempt_id.as_str() != attempt_id.as_str()
                    || child.deferred_wake.is_some()
                ...
                ResolvedSend::Admit {
                    ...
                    target: self.current_target_incarnation(subagent_id),
                }
            }
